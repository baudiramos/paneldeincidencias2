...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        echo "Por favor entra un usuario";
    } else{
...
<form id="formulario" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <div class="container">
            ...
            <br>
            <input type="submit" name="acceder" id="btn" value="Acceder">
            
            </div>
            </div>
            <div class="imagenlogo">
            <a href="#"><img style="width: 100px; heigth: 100px;" src="image/logo.png" alt=""></a>
            </div>
